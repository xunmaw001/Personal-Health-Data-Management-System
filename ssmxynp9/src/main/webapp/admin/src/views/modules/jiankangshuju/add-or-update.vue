    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="饮食习惯" prop="yinshixiguan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="饮食习惯"
                  v-model="ruleForm.yinshixiguan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yinshixiguan" label="饮食习惯" prop="yinshixiguan">
                    <span>{{ruleForm.yinshixiguan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="运动习惯" prop="yundongxiguan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="运动习惯"
                  v-model="ruleForm.yundongxiguan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yundongxiguan" label="运动习惯" prop="yundongxiguan">
                    <span>{{ruleForm.yundongxiguan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
