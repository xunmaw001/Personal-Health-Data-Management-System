      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饮食建议" prop="yinshijianyi">
          <el-input v-model="ruleForm.yinshijianyi" 
              placeholder="饮食建议" clearable  :readonly="ro.yinshijianyi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饮食建议" prop="yinshijianyi">
              <el-input v-model="ruleForm.yinshijianyi" 
                placeholder="饮食建议" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运动建议" prop="yundongjianyi">
          <el-input v-model="ruleForm.yundongjianyi" 
              placeholder="运动建议" clearable  :readonly="ro.yundongjianyi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运动建议" prop="yundongjianyi">
              <el-input v-model="ruleForm.yundongjianyi" 
                placeholder="运动建议" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  data() {
	...
	clicknum : false,
      ...
      rules: {
          ...
          yundongjianyi: [
                { required: true, message: '运动建议不能为空', trigger: 'blur' },
          ],
          beizhu: [
          ],
          fengmian: [
