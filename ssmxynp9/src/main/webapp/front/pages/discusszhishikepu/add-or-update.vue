	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusszhishikepu`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discusszhishikepu`, this.ruleForm);
				}else{
					await this.$api.add(`discusszhishikepu`, this.ruleForm);
				}
